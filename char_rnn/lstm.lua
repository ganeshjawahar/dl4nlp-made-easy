...
-----------------------------------------------------------------
Long-short Term Memory Network for Character-level language model
-----------------------------------------------------------------
...
for L = 1, num_layers do
	table.insert(init_state, torch.zeros(batch_size, rnn_size)) -- c[0]
    table.insert(init_state, torch.zeros(batch_size, rnn_size)) -- h[0]
end
...
print('LSTM training loss = '..loss[1])